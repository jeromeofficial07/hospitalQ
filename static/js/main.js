...
(function initLandingDeptCards() {
    ...
    fetchDeptData();
    // Every 15s was firing on the public landing page for every
    // visitor regardless of whether they're even looking at this
    // section — 45s is still fresh enough for a marketing/preview
    // page and cuts this specific load by two-thirds.
    setInterval(fetchDeptData, 45000);
})();
